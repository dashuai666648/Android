...
public final class NotePad {
    ...
    public static final class Notes implements BaseColumns {
        ...
        /**
         * Column name for the todo status (0 = normal note, 1 = todo item)
         * <P>Type: INTEGER</P>
         */
        public static final String COLUMN_NAME_IS_TODO = "is_todo";
        
        /**
         * Column name for the todo completion status (0 = incomplete, 1 = complete)
         * <P>Type: INTEGER</P>
         */
        public static final String COLUMN_NAME_TODO_COMPLETED = "todo_completed";
    }
}
